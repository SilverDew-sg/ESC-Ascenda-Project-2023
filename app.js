...
app.get('/api/disphotels', async (req, res) => {
  try {
    ...
    //const hotelpriceapi = 'https://hotelapi.loyalty.dev/api/hotels/diH7/price?destination_id=WD0M&checkin=2023-10-01&checkout=2023-10-07&lang=en_US&currency=SGD&country_code=SG&guests=2&partner_id=1'
